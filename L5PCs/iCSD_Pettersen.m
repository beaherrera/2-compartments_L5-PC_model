...
if Ih % Ih present
    save(fullfile(file,'CSD.mat'), 'tspan', 'zs', 'iCSD');
else % Ih blocked
    save(fullfile(file,'CSDNoIh.mat'), 'tspan', 'zs', 'iCSD');
end
...
if ~isempty(lfpT)
    ...
    for trial=1:length(lfpT(1,1,:))
        ...
        if Ih % Ih present
            save(fullfile(file,'CSDT.mat'), 'tspan', 'zsT', 'iCSDT');
        else % Ih blocked
            save(fullfile(file,'CSDNoIhT.mat'), 'tspan', 'zsT', 'iCSDT');
        end
