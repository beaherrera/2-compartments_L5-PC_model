...
% Ca_i = Xs(1:CSR:end,6*unit_number+1:(6+1)*unit_number) + stdInstCa.*randn(size(Xs(1:CSR:end,7),1),1); % intracellular Ca2+ concentration, it's downsampled
...
save([file '\voltageNoIhTrial' num2str(trial) '.mat'], 'voltage', '-v7.3');
save([file '\currentsNoIhTrial' num2str(trial) '.mat'], 'Ysd', 'I_trans', '-v7.3');
save([file '\ICaLNoIhTrial' num2str(trial) '.mat'], 'ICaL', '-v7.3');
